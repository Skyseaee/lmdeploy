...
constexpr DataType   TYPE_FP8_E4M3     = ft::TYPE_FP8_E4M3;
...
struct AbstractTransformerModel {
    ...
    virtual std::vector<std::vector<ft::NcclParam>>
    ...
    createModelInstance(int                                                               deviceId,
                        int                                                               rank,
                        cudaStream_t                                                      stream,
                        std::vector<std::vector<ft::NcclParam>>                           nccl_params,
    ...
    virtual int         enableExpertParallel() = 0;
    virtual int         enableAttentionDP()    = 0;
};
