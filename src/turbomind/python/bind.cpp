...
PYBIND11_MODULE(_turbomind, m)
{
    ...
    py::class_<ft::ScheduleMetrics, std::shared_ptr<ft::ScheduleMetrics>>(m, "ScheduleMetrics")
        ...
        .def_readonly("decode_count", &ft::ScheduleMetrics::decode_count)
        .def_readonly("prefill_count", &ft::ScheduleMetrics::prefill_count)
        .def_readonly("hit_rate", &ft::ScheduleMetrics::hit_rate)
        .def_readonly("cache_query_hit", &ft::ScheduleMetrics::cache_query_hit)
        .def_readonly("cache_query_total", &ft::ScheduleMetrics::cache_query_total);
