...
#include "src/turbomind/kernels/cutlass_kernels/moe_gemm/moe_tma_warp_specialized_traits.h"
...
public:
    ...
    */
    ...
    void operator()(Params const& params, SharedStorage& shared_storage)
    {
        ...
        CUTLASS_NOT_IMPLEMENTED();
        // static_assert(
        //     false, "Invalid architecture being compiled. Only Ampere+ supported in weight-only quantization
        //     kernels.");
#endif
#else
        CUTLASS_NOT_IMPLEMENTED();
