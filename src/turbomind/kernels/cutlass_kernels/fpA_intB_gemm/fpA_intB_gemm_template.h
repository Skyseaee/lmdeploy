...
#include "src/turbomind/kernels/cutlass_extensions/include/cutlass_extensions/gemm/device/gemm_universal_base_compat.h"
...
#include "src/turbomind/kernels/cutlass_extensions/include/cutlass_extensions/gemm/kernel/fpA_intB_gemm.h"
...
#include "src/turbomind/kernels/cutlass_kernels/fpA_intB_gemm/fpA_intB_gemm_template_sm90.h"
    ...
    OutputType>::CutlassFpAIntBGemmRunner()
{
    ...
    sm_ = ft::getSMVersion();
    ft::check_cuda_error(cudaDeviceGetAttribute(&multi_processor_count_, cudaDevAttrMultiProcessorCount, device));
}
