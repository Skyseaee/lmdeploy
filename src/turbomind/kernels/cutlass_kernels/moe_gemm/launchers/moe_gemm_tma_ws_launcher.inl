...
template <typename ArchTag, typename T, typename WeightType, typename OutputType, typename EpilogueTag,
    EpilogueFusion FUSION, typename TileShape, typename ClusterShape, bool BIAS>
    ...
    size_t* workspace_size)
{
    ...
    {
        throw std::runtime_error("Invalid architecture instantiated");
    }
    ...
    {
        throw std::runtime_error("Please recompile with support for hopper by passing 90-real as an arch to build_wheel.py.");
    }
    ...
    {
        throw std::runtime_error("Please recompile with support for blackwell by passing 100-real as an arch to build_wheel.py.");
    }
#endif
#ifndef COMPILE_BLACKWELL_SM120_TMA_GROUPED_GEMMS
    else if constexpr (ArchTag::kMinComputeCapability >= 120)
    {
        throw std::runtime_error("Please recompile with support for blackwell by passing 120-real as an arch to build_wheel.py.");
    }
#endif
    else
    {
        return DispatchToTmaWSFunction<ArchTag, T, WeightType, OutputType, EpilogueTag, FUSION, TileShape, ClusterShape,
            BIAS>::op(tma_ws_input, num_experts, multi_processor_count, stream, kernel_occupancy, workspace_size);
    }
}
...
#define INSTANTIATE_TMA_WARP_SPECIALIZED_MOE_GEMM(ArchTag_, DataType_, WeightType_, OutputType_, EpilogueTag_,                                                                                                                         \
    FUSION_, CTA_M_, CTA_N_, CTA_K_, CGA_M_, CGA_N_, CGA_K_, BIAS_)                                                                                                                                                                    \
    static void                                                                                                                                                                                                                        \
        tma_warp_specialized_generic_moe_gemm_kernelLauncher_##ArchTag_##_##DataType_##_##WeightType_##_##OutputType_##_##EpilogueTag_##_##FUSION_##_##CTA_M_##_##CTA_N_##_##CTA_K_##_##CGA_M_##_##CGA_N_##_##CGA_K_##_##BIAS_(        \
    ...
    {                                                                                                                                                                                                                                  \
        ...
        {                                                                                                                                                                                                                              \
            ...
            constexpr static bool IsSM120 = Arch::kMinComputeCapability == 120;                                                                                                                                                        \
                                                                                                                                                                                                                                       \
            ...
            constexpr static bool IsFP8 = cutlass::platform::is_same<T, SafeFP8>::value;                                                                                                                                               \
                                                                                                                                                                                                                                       \
            constexpr static bool IsBlockScaled = IsFP4;                                                                                                                                                                               \
            ...
            using ElementRouterScales = float;                                                                                                                                                                                         \
                                                                                                                                                                                                                                       \
            using ElementSF = cutlass::float_ue4m3_t; /*TmaWarpSpecializedGroupedGemmInput::ElementSF;*/                                                                                                                               \
            ...
            constexpr static int AlignmentB = 128                                                                                                                                                                                      \
                / cutlass::sizeof_bits<ElementB>::value; /* Memory access granularity/alignment of B matrix in units                                                                                                                   \
            ...
            using EpilogueScheduleBW = std ::conditional_t<Arch::kMinComputeCapability == 120, EpilogueScheduleSM120,                                                                                                                  \
            ...
            using KernelScheduleSM100 = std::conditional_t<Is2SM,                                                                                                                                                                      \
                std::conditional_t<IsBlockScaled, cutlass::gemm::KernelPtrArrayTmaWarpSpecialized2SmNvf4Sm100,                                                                                                                         \
                    cutlass::gemm::KernelPtrArrayTmaWarpSpecialized2SmSm100>,                                                                                                                                                          \
                std::conditional_t<IsBlockScaled, cutlass::gemm::KernelPtrArrayTmaWarpSpecialized1SmNvf4Sm100,                                                                                                                         \
                    cutlass::gemm::KernelPtrArrayTmaWarpSpecialized1SmSm100>>;                                                                                                                                                         \
            using KernelScheduleSM120 = cutlass ::gemm ::collective::KernelScheduleAuto;                                                                                                                                               \
            using KernelScheduleBW                                                                                                                                                                                                     \
                = std::conditional_t<Arch::kMinComputeCapability == 120, KernelScheduleSM120, KernelScheduleSM100>;                                                                                                                    \
                                                                                                                                                                                                                                       \
            ...
            {                                                                                                                                                                                                                          \
                throw std::runtime_error("TMA WS kernels do not support calculating occupancy");                                                                                                                                                     \
                return;                                                                                                                                                                                                                \
            }                                                                                                                                                                                                                          \
                                                                                                                                                                                                                                       \
            ...
            turbomind::FT_CHECK(tma_ws_input.stride_a);                                                                                                                                                                                         \
            turbomind::FT_CHECK(tma_ws_input.stride_b);                                                                                                                                                                                         \
            turbomind::FT_CHECK(tma_ws_input.ptr_a);                                                                                                                                                                                            \
            turbomind::FT_CHECK(tma_ws_input.ptr_b);                                                                                                                                                                                            \
                                                                                                                                                                                                                                       \
            auto make_mainloop_params = [&]() -> MainloopArguments                                                                                                                                                                     \
            {                                                                                                                                                                                                                          \
                if constexpr (IsFP4)                                                                                                                                                                                                   \
                {                                                                                                                                                                                                                      \
                    return construct_if_true<IsFP4, MainloopArguments>(                                                                                                                                                                \
                        ...
                        reinterpret_cast<ElementSF const**>(tma_ws_input.fp4_block_scaling_factors_B),                                                                                                                                 \
                        tma_ws_input.fp4_block_scaling_factors_stride_B,                                                                                                                                                               \
                        reinterpret_cast<ElementSF const**>(tma_ws_input.fp4_block_scaling_factors_A),                                                                                                                                 \
                        tma_ws_input.fp4_block_scaling_factors_stride_A);                                                                                                                                                              \
                }                                                                                                                                                                                                                      \
                else                                                                                                                                                                                                                   \
                {                                                                                                                                                                                                                      \
                    return construct_if_true<!IsFP4, MainloopArguments>(                                                                                                                                                               \
            ...
            FT_CHECK_WITH_INFO(calculated_ws_size <= tma_ws_input.gemm_workspace_size,                                                                                                                                               \
                turbomind::fmtstr("Workspace is size %zu but only %zu were allocated", calculated_ws_size,                                                                                                                                               \
            ...
            turbomind::sync_check_cuda_error_stream(stream);                                                                                                                                                                                             \
        }                                                                                                                                                                                                                              \
        else                                                                                                                                                                                                                           \
        {                                                                                                                                                                                                                              \
            throw std::runtime_error("Configuration was disabled by FAST_BUILD");                                                                                                                                                                    \
        }                                                                                                                                                                                                                              \
                                                                                                                                                                                                                                       \
        return;                                                                                                                                                                                                                        \
    }                                                                                                                                                                                                                                  \
    ...
    struct DispatchToTmaWSFunction<cutlass::arch::ArchTag_, DataType_, WeightType_, OutputType_,                                                                                                                                       \
        ...
        cute::Shape<cute::Int<CGA_M_>, cute::Int<CGA_N_>, cute::Int<CGA_K_>>, BIAS_>                                                                                                                                                   \
    {                                                                                                                                                                                                                                  \
