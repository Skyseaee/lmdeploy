...
def generate_sm90_operations(is_arch_enabled):
    ...
    operations = generate_sm90_grouped_gemm_operations(is_arch_enabled)
    operations.extend(
...
if __name__ == "__main__":
    ...
    fpA_intB_inl = "src/turbomind/kernels/cutlass_kernels/fpA_intB_gemm/launchers/fpA_intB_launcher_sm90.inl"
    moe_gemm_inl = "src/turbomind/kernels/cutlass_kernels/moe_gemm/launchers/moe_gemm_tma_ws_launcher.inl"
    # moe_gemm_inl = "src/turbomind/kernels/internal_cutlass_kernels/src/moe_gemm/launchers/moe_gemm_tma_ws_launcher.inl"
    moe_mixed_gemm_inl = "src/turbomind/kernels/cutlass_kernels/moe_gemm/launchers/moe_gemm_tma_ws_mixed_input_launcher.inl"
    # moe_mixed_gemm_inl = "src/turbomind/kernels/internal_cutlass_kernels/src/moe_gemm/launchers/moe_gemm_tma_ws_mixed_input_launcher.inl"
    # sm80_moe_gemm_inl = "src/turbomind/kernels/cutlass_kernels/moe_gemm/launchers/fused_moe_gemm_launcher_sm80.inl"
    # sm80_moe_gemm_inl = "src/turbomind/kernels/internal_cutlass_kernels/src/moe_gemm/launchers/fused_moe_gemm_launcher_sm80.inl"
    sm80_moe_gemm_inl = "src/turbomind/kernels/cutlass_kernels/moe_gemm/launchers/fused_moe_gemm_launcher_sm80.inl"
    ...
    def has_arch(sm):
        return f"{sm}" in arches or f"{sm}a-real" in arches or f"{sm}-real" in arches
