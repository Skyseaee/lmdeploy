...
public:
    ...
    GemmIdCore(int n_, int k_, turbomind::DataType const& dtype_)
        : n(n_)
        , k(k_)
        , dtype(dtype_)
    {
...
public:
    bool transA{};
    bool transB{};
    turbomind::DataType outputDtype;

    GemmIdCublas(int n_, int k_, turbomind::DataType const& dtype_, bool transA_, bool transB_,
        turbomind::DataType const& output_dtype_)
