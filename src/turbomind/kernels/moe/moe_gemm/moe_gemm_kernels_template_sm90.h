...
#define SHAPE_CASE(M, N, K)                                                                                            \
    ...
    {                                                                                                                  \
        ...
        {                                                                                                              \
            throw std::runtime_error("Unsupported tile and cluster shape combination");                                              \
        }                                                                                                              \
    }
...
#undef SHAPE_CASE
    default: throw std::runtime_error("Unsupported config for MoE gemm.");
    }
} // namespace tensorrt_llm
...
#undef SHAPE_CASE
    case cutlass_extensions::CutlassTileConfigSM90::Undefined: throw std::runtime_error("GEMM config undefined."); break;
    case cutlass_extensions::CutlassTileConfigSM90::ChooseWithHeuristic:
        ...
        break;
    default: throw std::runtime_error("Unsupported config for MoE gemm."); break;
    }
}
