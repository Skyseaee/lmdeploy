...
def generate_sm90_grouped_gemm_operations():
    arch = 90
    supported_dtypes = [
        DataType.f16, DataType.bf16, DataType.e4m3
    ]
...
if __name__ == "__main__":
    ...
    moe_gemm_inl = "src/turbomind/kernels/moe/moe_gemm/launchers/moe_gemm_launcher_sm90.inl"
    sm80_moe_gemm_inl = "src/turbomind/kernels/moe/moe_gemm/launchers/fused_moe_gemm_launcher_sm80.inl"
