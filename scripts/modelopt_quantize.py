...
# @Date     : 2024-12-17 14:23:45
# @Details  : fp8 quantization with modelopt
################################################################################
"""
...
# Usage: python3 modelopt_quantize.py --model_dir <HF model> --qformat fp8 --calib_size 512 --export_fmt onellm --output_dir <exported_model>
