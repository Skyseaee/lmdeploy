...
def read_dataset(dataset_path: str, samples: int):
    ...
    if dataset_path.endswith("csv"):
        ...
        assert False, "dataset_path format not supported"

    logging.info(f'elapsed time for read {len(prompts)} data: '
...
def main(server_addr: str,
    ...
    warmup(server_addr, concurrency, out_len)
    req_queue, n_req = read_dataset(dataset_path, samples)
    ...
    latency_p95 = np.percentile(res_latency_list, 95)
    ...
    data = {"Gen_Token_Len Setting": out_len,
            ...
            "Latency_P95/s": round(latency_p95, 3),
    ...
    header = "Gen_Token_Len Setting, Batch Size/Concurrency, Avg_Input_Token_Len, Avg_Gen_Token_Len, " \
             ...
             "Latency_P90/s, Latency_P95/s, Latency_P99/s, Latency_AVG/s, Token QPS(token/s), QPS(req/s)\n"
    with open(csv_file_path, 'a') as f:
        ...
        line = f'{out_len},{concurrency},{input_token_avg:.2f},{gen_token_avg:.2f},' \
               ...
               f'{latency_p50:.3f},{latency_p90:.3f},{latency_p95:.3f},{latency_p99:.3f},{latency_avg:.3f},' \
